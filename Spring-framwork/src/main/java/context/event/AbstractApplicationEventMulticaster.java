...
public abstract class AbstractApplicationEventMulticaster implements ApplicationEventMulticaster, BeanFactoryAware {
    ...
    /**
     * lister is or not match with the event
     * @param applicationListener
     * @param event
     * @return
     */
    protected boolean supportEvent(ApplicationListener applicationListener, ApplicationEvent event) {
